...
public class AdapterCommentExpand extends ExpandableRecyclerAdapter<AdapterCommentExpand.CommentItem> {
    public static final int TYPE_PERSON = 1001;

    public AdapterCommentExpand(Context context) {
        super(context);
...
//    @Override
    ...
    private List<CommentItem> getSampleItems() {
        List<CommentItem> items = new ArrayList<>();

        items.add(new CommentItem("Friends"));
        items.add(new CommentItem("hi my name is praful deshmukh \n" +
                "(open for extension but closed for modification)", "Smith"));
        items.add(new CommentItem("hi my name is harshal bhende  \n" +
                "(open for extension but closed for modification)", "Doe"));
        items.add(new CommentItem("hi my name is chhavi rajput \n" +
                "(open for extension but closed for modification)", "Hall"));
        items.add(new CommentItem("hi my name is Shefali Pandhare \n" +
